...
//Copy Constructor
template <class T>
LinkedList15<T>::LinkedList15(LinkedList15<T>* L) {
	head = nullptr;
	link_size = L->link_size;
	LinkNode15<T>* copyNodePtr;

	LinkNode15<T>* newlyCreatedNode;

	LinkNode15<T>* previouslyCreatedNewNode;

	LinkNode15<T>* nodePtr;
	...
	if (L->head == nullptr) {
		...
		newlyCreatedNode = new LinkNode15<T>(copyNodePtr->value);
...
//Linked List Operations
template<class T>
void LinkedList15<T>::appendNode(T v) {

	LinkNode15<T>* newNode;
	LinkNode15<T>* nodePtr;

	//Allocate a new node and store an int there;
	newNode = new LinkNode15<T>(v);
...
void LinkedList15<T>::insertNode(T v) {

	LinkNode15<T>* newNode;
	LinkNode15<T>* nodePtr;
	LinkNode15<T>* previousNode = nullptr;
...
template<class T>
void LinkedList15<T>::deleteNode(T v) {
	LinkNode15<T>* nodePtr; //used to traverse the list
	LinkNode15<T>* previousNode = nullptr; // to point to the previouse node
...
template<class T>
void LinkedList15<T>::print() const {
	LinkNode15<T>* nodePtr;
...
template<class T>
void LinkedList15<T>::reverseList() {
	LinkNode15<T>* currentNode = nullptr;
	LinkNode15<T>* previousNode = nullptr;
	LinkNode15<T>* nextNode = nullptr;
...
template<class T>
void LinkedList15<T>::insertAtPosition(int position, T value) {
	...
	newNode = new LinkNode15<T>(value);
...
template<class T>
void LinkedList15<T>::removeAtPosition(int position) {
...
template <class T>
T LinkedList15<T>::returnLargest() {
...
template <class T>
T LinkedList15<T>::returnSmallest() {
...
template<class T>
T LinkedList15<T>::returnValueAtIndex(int position) {
...
template<class T>
int LinkedList15<T>::returnListSize() {
	return link_size;
}

template<class T>
void LinkedList15<T>::pop_back() {
	LinkNode15<T>* nodePtr;
	LinkNode15<T>* previousNode = nullptr;
...
template<class T>
void LinkedList15<T>::push_back(T v) {
	LinkNode15<T>* newNode;
	LinkNode15<T>* nodePtr;
...
template<class T>
void LinkedList15<T>::push_front(T v) {
	LinkNode15<T>* newNode;
	LinkNode15<T>* nodePtr;
...
//Operator Overloading
template<class T>
T& LinkedList15<T>::operator[](const int& sub) {
