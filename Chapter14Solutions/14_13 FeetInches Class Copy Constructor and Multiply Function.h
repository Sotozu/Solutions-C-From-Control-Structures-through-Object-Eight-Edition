...
public:
	...
	//Copy Constructor
	FeetInches13(const FeetInches13& obj) {
		feet = obj.feet;
		inches = obj.inches;
	}
	...
	FeetInches13 operator + (const FeetInches13& right)
	{
		FeetInches13 temp;
	...
	// Overloaded binary <= operator.             * 
	//********************************************** 
	bool operator<=(const FeetInches13& right) {
		bool status;
	...
	void operator = (const FeetInches13& right) {
		inches = right.inches;
		feet = right.feet;
	}
